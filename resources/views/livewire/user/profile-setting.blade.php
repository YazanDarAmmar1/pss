            ...
            <div class="bxp d-flex space-between flex-column-p gap-20 gap-65-p">
                ...
                <div class="right-side">
                    ...
                    <ul class="list-none breadcrumb-in d-flex wrap gap-15">
                        ...
                        <li>
                            <a class="body-color to-color" href="{{route('profile')}}">
                                {{__('الملف الشخصي')}}
                            </a>
                        </li>
            ...
            <div class="box d-flex flex-column-p align-center-p gap-80">
                ...
                <div class="right shrink-0 mx-auto-p" style="width: 240px;">
                    ...
                    <figure class="prof-av d-flex relative mb-30">
                        ...
                        <div class="rounded my-avatar-fig overflow-hidden relative"
                        ...
                        <div class="full-el flv d-flex align-end justify-end">
                            ...
                            <label for="avatar-upload"
                                   class="bg-white flex-all btn-upl rounded border-0 shadow"
                                   style="width: 60px;height:60px; cursor: pointer;">

                                <img src="{{ asset('home-assets/images/camera.svg') }}"
                                     width="30"/>
                    ...
                    <p class="gray-4 center vz2 font-20 f-500">
                        {{__('يُفضل استخدام صورة بحجم 400x400 بكسل')}}
                    </p>
                ...
                <div class="left flex-1 w-100-p">
                    ...
                    <p class="t23 black-3 font-22 bold pb-25">
                        ...
                        <form wire:submit="save">
                            ...
                            <div class="form-box d-flex flex-column gap-25">
                                ...
                                <div>
                                    ...
                                    <p class="gdf bold font-22 pb-10">
                                        {{__('تغيير كلمة السر')}}
                                    </p>

                                    <p class="bzv font-18 f-500">
                                        {{__('اترك الحقول فارغة إذا كنت لا ترغب في تغيير كلمة السر')}}
                                    </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="font-14 main-color d-flex gap-10 pointer">
                                        <span>{{ $message }}</span>
                                    </label>
                                ...
                                <div class="grid-full-row d-flex accccc gap-40 gap-20-p">
                                    ...
                                    <a href="{{route('profile')}}"
                                       class="btn btn-outline-trans flex-1">
