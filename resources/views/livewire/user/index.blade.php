            ...
            <div class="box w-100-p bg-white border-red radius-24 mx-auto pt-25 pb-25 px-40">
                ...
                <div class="actions mb-10 d-flex justify-end">
                    ...
                    <a href="{{route('settings')}}"
                       class="btn-0 flex-all">

                        <img src="{{asset('home-assets/images/edit-profile.svg')}}"
                             width="32"
                             height="32"/>
                ...
                <figure class="fig flex-all mb-30">
                    ...
                    <img src="{{Auth::user()->full_image_path}}"
                         width="112"
                         height="112"
                ...
                <div class="cntnt center">
                    ...
                    <p class="zc bold font-24 pb-10">
                        {{Auth::user()->name}}
                    </p>

                    <p class="zc2 justify-center font-16 pb-10 d-flex align-center gap-5">

                        <img src="{{asset('home-assets/images/mail-2.svg')}}"
                             width="16"/>
                ...
                <div class="profile-table-1">
                    ...
                    <div class="profile-table-box bg-white border-red radius-24 mb-40 mb-20-p">
                        ...
                        <div class="profile-head-with-filters" x-data="{ open: false }">
                            ...
                            <!-- #head -->
                            <div
                                class="profile-table-head d-flex align-center space-between py-15 px-30 px-15-p gap-40 gap-10-p">

                                <!-- #right -->
                                <div class="head-right shrink-0 d-flex align-center gap-15 gap-7-p">

                                    <img src="{{ asset('home-assets/images/solar-card.svg') }}"
                                         width="40"
                                         height="40"
                                         class="asdz"/>

                                    <p class="zxcq12 black font-24 font-16-p f-600">
                                        {{__('تبرعاتي السابقة')}}
                                    </p>
                                ...
                                <div class="search-with-filters-wrap d-flex gap-15 gap-5-p">
                                    ...
                                    <button @click="open = !open"
                                        ...
                                        <img class="trans do-only"
                                             ...
                                             src="{{ asset('home-assets/images/chev-down.svg') }}"
                                             width="14"
                                             height="14"/>

                                        <img class="trans mo-only"
                                             src="{{ asset('home-assets/images/filters-red.svg') }}"
                                             width="24"
                                             height="24"/>
                                    ...
                                    <div class="bbbbb1 grid-4 grid-2-t gap-15 pt-30 pb-30">
                                        ...
                                        <div class="filter-item">
                                            ...
                                            <div class="input-with-icon relative">
                                                ...
                                                <img class="icn"
                                                     src="{{ asset('home-assets/images/date-icon.svg') }}"
                                                     width="24"
                                                     height="24"/>
                                        ...
                                        <div class="filter-item">
                                            ...
                                            <div class="input-with-icon relative">
                                                ...
                                                <img class="icn"
                                                     src="{{ asset('home-assets/images/payments-icon.svg') }}"
                                                     width="24"
                                                     height="24"/>
                                        ...
                                        <td width="1">
                                            ...
                                            <div class="table-actions flex-all">
                                                ...
                                                <button wire:click="viewReceipt({{ $receipt->id }})"
                                                    ...
                                                    <span class="text-grad do-only">
                                                        {{__('عرض')}}
                                                    </span>

                                                    <img src="{{ asset('home-assets/images/eye-red.svg') }}"
                                                         width="17"
                                                         height="17"
                                                         class="zzzzq1">
            ...
            <div class="modal-body-wrapper">
                ...
                <div class="modal-body relative z-1 bg-white radius-24 pt-40 pb-40 px-40">
                    ...
                    <button wire:click="closeReceipt"
                            class="cls-modal flex-all btn-0">

                        <img src="{{ asset('home-assets/images/close.svg') }}"
                             width="32"
                             height="32">

                    </button>

                    <p class="black bold font-22 pb-25">
                        {{__('تفاصيل الإيصال')}}
                    </p>
                    ...
                    <div class="d-flex flex-column gap-15 pb-25">
                        ...
                        <div class="d-flex space-between gap-10">
                            ...
                            <span class="bold">
                                {{ $selectedReceipt->payment_method->label() }}
                            </span>
                    ...
                    {{-- المشاريع --}}
                    <p class="black bold font-18 pb-15">
                        {{__('المشاريع')}}
                    </p>
                    ...
                    <div class="d-flex space-between align-center">
                        ...
                        <span class="black bold font-20">
                            {{__('الإجمالي')}}
                        </span>

                        <span class="text-grad bold font-24">
                            {{ $selectedReceipt->amount }} BHD
                        </span>
