                ...
                <div class="do">
                    <div class="middle-side d-flex gap-30 space-between align-center">
                        ...
                        <ul class="main-menu-box d-flex list-none gap-25">
                            <!-- #item -->
                            <li>
                                <a href="{{route('projects')}}" wire:current.class="active" wire:navigate.hover class="menu-item black trans bold relative">مشاريعنا</a>
                            </li>
                            <!-- ##item -->
                            <!-- #item -->
                            <li>
                                <a href="{{route('news')}}" wire:current.class="active" wire:navigate.hover class="menu-item black trans bold relative">أخبارنا</a>
                            </li>
                            <!-- ##item -->
                            <!-- #item -->
                            <li>
                                <a href="{{route('library')}}" wire:current.class="active" wire:navigate.hover class="menu-item black trans bold relative">مكتبتنا</a>
                            </li>
                            <!-- ##item -->
                            <!-- #item -->
                            <li>
                                <a href="{{route('about-us')}}" wire:current.class="active" wire:navigate.hover class="menu-item black trans bold relative">من نحن</a>
                            </li>
                            <!-- ##item -->
                            <!-- #item -->
                            <li>
                                <a href="{{route('contact-us')}}" wire:current.class="active" wire:navigate.hover class="menu-item black trans bold relative">تواصل معنا</a>
                            </li>
                            <!-- ##item -->
                        </ul>
                        <!-- ##main menu (desktop only) -->
                ...
                <div class="btns-header d-flex align-center gap-15">
                    ...
                    <div class="wrap-just">
                        <div class="right-options d-flex align-center gap-15">
                            ...
                            <a href="/{{ $switchTo }}/{{ $cleanPath }}" class="btn-header do-only btn-header-lang d-flex align-center gap-7 font-14 font-2 black">
                                @if($currentLocale === 'ar')
                                    <img src="{{asset('home-assets/images/flag-en.svg')}}" width="28" height="20" class="radius-4"/>
                                    <span>EN</span>
                                @else
                                    <img src="{{asset('home-assets/images/flag-en.svg')}}" width="28" height="20" class="radius-4"/>
                                    <span>AR</span>
                            ...
                            <button open-modal="search-modal" class="btn-0 btn-head-with-badge search-header-btn">
                                <img src="{{asset('home-assets/images/search-icon.svg')}}" width="40" height="auto" class="rounded"/>
                            </button>
                            <button wire:click="userBasketBoxModal" class="btn-0 btn-head-with-badge cart-header-btn">
                                <img src="{{asset('home-assets/images/basket-red-menu.svg')}}" width="40" height="auto" class="rounded"/>
                    ...
                    @else
                        ...
                        <a wire:navigate href="{{route('profile')}}" class="header-user-in black d-flex align-center gap-7">
                            <img class="object-fit rounded" src="#" width="50" height="50"/>
                                ...
                                <ul class="list-none d-flex flex-column gap-5">
                                    <li>
                                        <a class="d-flex align-center gray-9 f-600 font-18 ibx gap-7 pt-10 pb-10"
                                           href="{{route('profile')}}">
                                            <img src="{{asset('home-assets/images/menu-icon-1.svg')}}" width="24" height="24"/>
                                            <span>الإعدادات</span>
                                        </a>
                                    </li>
                                    <li class="logout-itm pt-15">
                                        <a class="d-flex justify-center align-center gray-9 f-600 font-18 ibx gap-7 pt-10 pb-10"
                                           href="{{route('user.auth.logout')}}">
                                            <img src="{{asset('home-assets/images/logout.svg')}}" width="24" height="24"/>
...
{{--                          <img width="24" src="{{asset('home-assets/')}}">--}}
{{--                          <span>تسجيل الخروج</span>--}}
{{--                        </button> --}}
                        <a href="/{{ $switchTo }}/{{ $cleanPath }}" class="btn-header btn-header-lang d-flex align-center gap-7 font-14 font-2 black">
                            @if($currentLocale === 'ar')
                                <img src="{{asset('home-assets/images/flag-en.svg')}}" width="28" height="20" class="radius-4"/>
                                <span>EN</span>
                            @else
