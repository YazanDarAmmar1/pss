<form wire:submit="register">
    ...
    <div class="form-box grid-2 gap-25" @registered.window="showRegister = false">
        ...
        <div class="form-group grid-full-row">
            ...
            <div class="input-with-icon relative">
                ...
                <img class="icn"
                     src="{{asset('home-assets/images/mobile.png')}}">
        ...
        <div class="form-group grid-full-row">
            ...
            <div class="input-with-icon relative">
                ...
                <img class="icn"
                     src="{{asset('home-assets/images/mail-gray.svg')}}">
        ...
        <div class="form-group">
            ...
            <div class="relative">
                ...
                <input wire:model="otp"
                       placeholder="12345"
                       class="form-control-with-icon no"
                       required>
        ...
        <div class="form-group grid-full-row-p">
            ...
            <div class="input-with-icon with-icon-after relative" password-input-root="">
                ...
                <img class="icn"
                     src="{{asset('home-assets/images/lock.svg')}}">

                <div class="password-icons flex-all">

                    <button type="button"
                            class="btn-0 h-100 w-100 icon-after-input relative"
                            toggle-password-btn="">

                        <img class="pointer trans shrink-0 no"
                             src="{{asset('home-assets/images/eye-off.svg')}}"
                             width="20">

                        <img class="pointer trans shrink-0 yes"
                             src="{{asset('home-assets/images/eye.svg')}}"
                             width="20">
    ...
    <div class="actions-form pt-30">
        ...
        <button class="btn btn-submit-disabled-state w-100">
            {{__('تسجيل')}}
        </button>
