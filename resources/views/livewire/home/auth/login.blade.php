<form wire:submit.prevent="login">
    ...
    <div class="form-box d-flex flex-column gap-25">
        ...
        <div class="form-group">
            ...
            <div x-data="{showPassword: false}"
                 class="input-with-icon with-icon-after relative"
                 password-input-root>
                ...
                <div class="password-icons flex-all">
                    ...
                    <button @click="showPassword = !showPassword"
                        ...
                        <img x-show="!showPassword"
                             class="pointer trans shrink-0 no"
                             src="{{asset('home-assets/images/eye-off.svg')}}"
                             width="20"/>

                        <img x-show="showPassword"
                             class="pointer trans shrink-0 yes"
            ...
            <div class="opt-pass d-flex space-between align-center pt-25">
                ...
                <a href="#" class="text-grad font-16">
                    {{__('نسيت كلمة المرور؟')}}
                </a>
    ...
    <div class="actions-form pt-30">
        ...
        <button type="submit"
                class="btn btn-submit-disabled-state w-100"
