        ...
        <div class="container full-p">
            ...
            <div class="toggle-tabs toggle-tabs-mo theme-2 d-flex gap-15 pb-40">
                ...
                <button wire:click="filterByCategory(null)"
                        class="toggle-tab-btn w-100 radius-30 no-wrap {{$category_id === null ? 'active' : ''}}">
                ...
                @foreach($this->book_category as $index => $category)
                    ...
                    <button type="button"
                            ...
                            class="toggle-tab-btn w-100 radius-30 no-wrap {{$category->id == $category_id ? 'active' : ''}}">
            ...
            <div class="box grid-3 grid-2-t grid-1-p gap-40 pt-40">
                ...
                @foreach($this->books as $book_index => $book)
                    ...
                    <div class="library_item_wrapper">
                        ...
                        <a href="{{ asset($book->book_file_path) }}"
                           target="_blank"
                           class="library_item box_hover overflow-hidden h-100 radius-12 bg-white d-flex flex-column space-between gap-25">
                            ...
                            <div class="xx d-flex flex-column gap-15 h-100">
                                ...
                                <figure class="fig d-flex relative">
                                    ...
                                    <img src="{{asset($book->image_path)}}"
                                         class="object-fit w-100 img trans"
                                         width="100%"
                                         height="231">

                                    <div class="fff full-el d-flex align-end pb-15 px-15">
                                        <p class="lq bg-secondary main-color bold font-16 py-10 px-25 radius-30">
                                    ...
                                    <div class="up-up d-flex flex-column gap-15">
                                        ...
                                        <div class="psa">
                                            ...
                                            <div class="hh d-flex space-between align-center">
                                                <p class="tt1 bold font-20 one-line main-color">
                                                    {{$book->name}}
                                                </p>
                                            </div>
