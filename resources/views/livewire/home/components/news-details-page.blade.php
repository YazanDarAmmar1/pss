        ...
        <div class="container">
            ...
            <div class="box">
                ...
                <div class="in bg-grad radius-24 center p-40 px-p">
                    ...
                    <p class="t1 title-32 pb-25">
                        {{__('ساهم في أحد مشاريعنا الأن')}}
                    </p>

                    <p class="d1 font-20 pb-25">
                        {{__('كل مساهمة تصنع فرقاً في حياة عائلة فلسطينية محتاجة')}}
                    </p>
            ...
            <div class="box grid-3 grid-2-t grid-1-p pt-25">
                ...
                @foreach($otherNews as $item)
                    ...
                    <a href="{{route('news.details', $item->id)}}"
                       class="related_news trans p-24 bg-white radius-24 gap-25 d-flex flex-column space-between">
                        ...
                        <div class="u">
                            ...
                            <figure class="dd relative d-flex mb-25">
                                <img src="{{asset($item->image_path)}}"
                                     width="100%"
                                     height="169"
                                     class="object-fit radius-12"/>
                            </figure>

                            <p class="t1 main-color bold two-line">
                                {{$item->name}}
                            </p>
