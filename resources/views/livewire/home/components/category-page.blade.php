    ...
    <div class="container full-p">
        ...
        <div class="head flex-all container-p">
            <div class="title-with-line">
                <span>{{__('مشاريعنا الإنسانية')}}</span>
            </div>
        </div>
        ...
        <div class="box grid-4 grid-2-t grid-1-p gap-40 pt-25 container-left-p">
            ...
            @foreach($categories as $category)
                ...
                <!-- #itm -->
                <a href="{{ route('projects', ['selected_category' => $category->id]) }}"
                   class="itm px-15 body-color py-25 relative d-flex gap-30 flex-column space-between radius-24 trans">
                    ...
                    <div class="btns flex-all px-40 relative">
                        <span class="btn sp">{{__('تبرع ألآن')}}</span>
                    </div>
