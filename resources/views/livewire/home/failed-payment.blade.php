        ...
        <div class="container">
            ...
            <div class="box center mx-auto">
                ...
                <figure class="flex-all ff">
                    ...
                    <img src="{{asset('home-assets/images/failed.png')}}"
                         width="150"/>
                ...
                <p class="dd gray-4 font-24 pb-40">
                    ...
                    {{__('نعتذر، لم تتم عملية التبرع بنجاح. يرجى التحقق من بيانات الدفع والمحاولة مرة أخرى. تبرعكم يعني الكثير لنا وللمستفيدين من خدماتنا الخيرية.')}}
                ...
                <div class="actions flex-all column-reverse-p gap-30">
                    ...
                    <a href="{{route('checkout')}}"
                       class="btn btn-primary w-100">
                        ...
                        <img src="{{asset('home-assets/images/retry.svg')}}"
                             width="24"/>
                    ...
                    <a href="{{route('home')}}"
                       class="btn btn-outline-trans w-100">
