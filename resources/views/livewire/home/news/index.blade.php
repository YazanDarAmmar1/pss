                ...
                <div class="wrapper-only d-flex flex-column gap-25">
                    ...
                    @foreach($news as $new)
                        ...
                        <a href="{{route('news.details', $new->id)}}"
                           class="news_item border-red radius-12 p-32 px-p d-flex gap-40 flex-column-p gap-40 bg-white">
                                ...
                                <div class="uu">
                                    ...
                                    <div class="psa pb-10">
                                        ...
                                        <div class="hh d-flex space-between align-center gap-5">
                                            <p class="tt1 bold font-20 main-color">
                                                {{$new->name}}
                                            </p>
                                        </div>
                                    ...
                                    <p class="da font-18 mb-25 two-line gray-4">
