                ...
                <div class="right-side w-50 w-100-p">
                    ...
                    <div class="box pt-10">
                        ...
                        <p class="vz2 text-grad font-36 center pb-10">
                            {{__('شكرًا لك على تبرعك!')}}
                        </p>

                        <p class="vz3 font-20 gray-4 center pb-30">
                            {{__('لقد ساهمت في صناعة أثر حقيقي في حياة من هم بأمس الحاجة للدعم. تبرعك يعني الكثير لنا وللمستفيدين.')}}
                        </p>
                        ...
                        <div class="form-inside">
                            ...
                            <div class="email-cont mx-auto mb-30 w-100-p">
                                ...
                                <div class="email-temp flex-all wrap gap-15">
                                    ...
                                    @if(!empty($this->email))
                                        ...
                                        <button x-transition
                                            ...
                                            <span wire:target="sendEmail" wire:loading.remove>
                                                {{__('إرسال الإيصال')}}
                                            </span>

                                            <span wire:target="sendEmail" wire:loading>
                                                {{__('جاري الإرسال...')}}
                                            </span>
                                ...
                                <p class="zxczz font-16 gray-4 align pt-10">
                                    {{__('يمكنك إضافة البريد الإلكتروني الذي ترغب بأن يصله إِشعار بالمبلغ المتبرع به.')}}
                                </p>
