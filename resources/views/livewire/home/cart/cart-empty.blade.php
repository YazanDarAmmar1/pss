<div class="modal-body-wrapper">
    ...
    <div class="modal-body relative z-1 bg-white radius-24 radius-16-p pt-40 pb-40 px-40">
        ...
        <div class="flex-all xxx mb-15">
            ...
            <img src="{{asset('home-assets/images/empty-cart.png')}}"
                 width="212"/>

        </div>

        <p class="cc center f-500 font-24 pb-30">
            {{__('سلة التبرع فارغة، لم يتم إضافة أي مشروع بعد')}}
        </p>

        <div class="actions flex-all pb-25-p">

            <a href="{{route('projects')}}"
               class="btn btn-primary img-inside w-100">

                {{__('تصفح المشاريع للتبرع')}}
