        ...
        <div x-show="!showRegister" x-transition class="container">
            ...
            <div class="box d-flex align-center flex-column-p gap-80">
                ...
                <div class="right w-43 w-100-p">
                    ...
                    <p class="tt text-grad bold font-40 pb-15 font-32-p">
                        {{__('تسجيل الدخول')}}
                    </p>

                    <p class="dd font-20 gray-4 pb-30 font-18-p">
                        {{__('جمعية مناصرة فلسطين تجمع الداعمين والناشطين في مكان واحد لتنظيم العمل، نشر الوعي، وتعزيز نصرة فلسطين.')}}
                    </p>
                ...
                <div class="left do-only d-flex w-53 w-100-p">
                    ...
                    <img src="{{asset('home-assets/images/login.png')}}"
                         width="100%"
                         class="object-fit"/>
